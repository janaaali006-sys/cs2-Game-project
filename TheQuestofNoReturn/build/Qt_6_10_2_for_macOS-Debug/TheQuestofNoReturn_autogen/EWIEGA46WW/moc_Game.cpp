...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gameEnded((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Game::*)()>(_a, &Game::gameStarted, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(bool )>(_a, &Game::gameEnded, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Game::*)(int )>(_a, &Game::levelChanged, 2))
            return;
    }
}
...
// SIGNAL 2
void Game::levelChanged(int _t1)
{
